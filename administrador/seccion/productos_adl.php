...
switch ($accion) {
    ...
    case "Agregar":
        ...
        header("Location: productos_adl.php");
        break;
        ...
        <div class="card-body">
            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" required class="form-control" value="<?php echo $textdescripcion; ?>" name="txtdescripcion" id="txtdescripcion" placeholder="Descripcion">
                </div>

                <div class="form-group">
                    <label for="txtprecio">Precio</label>
                    <input type="text" required class="form-control" value="<?php echo $textprecio; ?>" name="txtprecio" id="txtprecio" placeholder="Precio">
                </div>
