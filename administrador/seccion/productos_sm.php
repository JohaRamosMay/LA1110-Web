...
switch ($accion) {
    ...
    case "Agregar":
        ...
        header("Location: productos_sm.php");
        break;
        ...
        <div class="card-body">
            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text"  readonly class="form-control" value="<?php echo $textID; ?>" name="txtID" id="txtID" placeholder="ID">
                </div>

                <div class="form-group">
                    <label for="txtnombre">Titulo</label>
                    <input type="text"  class="form-control" value="<?php echo $textnombre; ?>" name="txtnombre" id="txtnombre" placeholder="Titulo">
                </div>
