...
<?php include("administrador/config/bdbj.php");
        ...
        <div class="row mb-5 justify-content-center">
            <div class="col-12">
                <h3 class="mbr-section-title mbr-fonts-style align-center mb-0 display-1">
                    <strong>Bullet Jounals</strong>
                </h3>
                <h5 class="mbr-section-subtitle mbr-fonts-style align-center mb-0 mt-4 display-7"><strong>El complemento perfecto de todo lector. <br> Son tamaño A5, en tapa dura y con ilustraciones exclusivas. <br>Cuentan con 10 páginas impresas ideales para llevar un tracking de tus lecturas, compras y más. <br> Las hojas son de 120 gramos cada una, vienen 80 hojas blancas y 20 kraft. <br> Cualquiera te sale en S/35.
                    </strong>
                </h5>
            </div>
        </div>
