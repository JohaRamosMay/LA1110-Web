...
<?php include("administrador/config/bdva.php");
        ...
        <div class="row mb-5 justify-content-center">
            <div class="col-12">
                <h3 class="mbr-section-title mbr-fonts-style align-center mb-0 display-1">
                    <strong>Velas Aromáticas</strong>
                </h3>
                <h5 class="mbr-section-subtitle mbr-fonts-style align-center mb-0 mt-4 display-7"><strong>Velas artesanales y aromáticas ideales para acompañar tus momentos de lectura y/o relajación. <br> Cada una tiene 200 ml y son de cera 100% vegetal. <br> Algunas cuentan con mecha de bambú y otras de algodón. <br>Cualquiera te sale a S/39.
                    </strong>
                </h5>
            </div>
        </div>
