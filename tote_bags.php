    ...
    <div class="container-fluid">
        <div class="row mb-5 justify-content-center">
            <div class="col-12">
                ...
                <h5 class="mbr-section-subtitle mbr-fonts-style align-center mb-0 mt-4 display-7"><strong>Ideales para llevar todo lo que necesites siempre contigo. <br> Son de drill grueso con tela, asas resistentes y diseños exclusivos. <br>Las medidas aproximadas son de 43 x 48cm. <br> Cualquiera cuesta S/30.
                    </strong>
                </h5>
            </div>
        </div>
