...
<?php include("administrador/config/bdpi.php");
    ...
    <div class="container-fluid">
        <div class="row mb-5 justify-content-center">
            <div class="col-12">
                ...
                <h5 class="mbr-section-subtitle mbr-fonts-style align-center mb-0 mt-4 display-7"><strong>Banderitas semitransparentes para poner en tus libros, agendas, cuadernos y más. <br> Cualquiera te sale en S/8. Consulta el stock actual por instagram.
                    </strong>
                </h5>
            </div>
        </div>
